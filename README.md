# PerCeptron
The PerCeptron is a basic AI unit representing one neuron. In this gitgub repository we have coded it in C.

## Techincal Description
A basic description of this C application and how to code it can be found in this YouTube Video below.

https://www.youtube.com/watch?v=
[![Watch the video](https://img.youtube.com/vi/4sqHZQ3rxpg/maxresdefault.jpg)](https://youtu.be/4sqHZQ3rxpg)
